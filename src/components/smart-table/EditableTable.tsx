...
const EditableTable: React.FC<EditableTableProps> = ({
            ...
            ...columns.map((col) => ({
                ...
                onCell: (record: any, rowIndex: number) => {
                    ...
                    return {
                        ...
                        editing: isEditing(record[rowKey]) && col.editable && col.editable !== false,
    ...
    }, [columns, form, name, handleCopy, remove, handleDelete, handleSave, handleEdit, handleCancel, editingKey, rowKey])
